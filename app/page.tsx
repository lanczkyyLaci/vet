  ...
  return (
    <>
      ...
      <Section id="hero" className="relative min-h-[70vh] overflow-hidden">
        ...
        <div className="py-20mx-auto relative mx-auto flex min-h-[70vh] max-w-6xl items-center px-4">
                ...
                <div className="relative h-full overflow-hidden rounded-lg bg-white shadow-xl ring-1 shadow-teal-900/5 ring-slate-200/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-teal-500/20 hover:ring-teal-300/50">
                  ...
                  <div className="relative p-6">
                    ...
                    <div className="pr-16">
                      ...
                      <p className="mt-3 leading-relaxed text-slate-600">
                        Hivatalos allatorvosi igazolasok, utlevelek,
                        export-import dokumentumok es hatarozatok.
                      </p>
                    </div>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              ...
              <Card className="border-blue-100 bg-white shadow-md">
                <CardHeader>
                  ...
                  <CardDescription className="text-base">
                    Azonnali állatorvosi segítség sürgős esetekben,
                    baleseteknél.
                  </CardDescription>
                </CardHeader>
              </Card>
