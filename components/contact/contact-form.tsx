...
import { EMAIL_ADDRESS } from "@/config/constatns";
        ...
        <div className="border-t border-blue-100 pt-6">
          <div className="mb-5">
            ...
            <p className="mt-1 text-sm leading-6 text-slate-500">
              Válassza ki a kívánt levelezőt — automatikusan megnyílik a címzett
              e-mail címével kitöltve.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            ...
            >
              <div className="flex items-start justify-between">
                <div>
                  <p className="font-medium">Megnyitás Gmail-ben</p>
            ...
            {isApple && (
              ...
              >
                <div className="flex items-start justify-between">
                  <div>
                    <p className="font-medium">Megnyitás Apple Mail-ben</p>

                    <p className="mt-1 text-sm text-slate-300">
                      Új levél írása az Apple Mail alkalmazásban.
                    </p>
                  </div>
